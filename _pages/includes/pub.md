...
<!-- <div style="background-color: #f0f7ff; border-left: 4px solid #0066cc; padding: 12px 16px; margin-bottom: 20px; border-radius: 4px;">
  <strong>💡</strong> Click "Show Figure" to view the corresponding figure.
</div> -->
...
<div class="paper-box">
  <div class="paper-box-text">
    <span class="report-tag">Tech Report</span> <a href="https://arxiv.org/pdf/2408.16768">SAM2Point: Segment Any 3D as Videos in Zero-shot and Promptable Manners</a>.<br>
